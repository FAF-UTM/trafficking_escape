        ...
        <div className={styles.chat_leftbar}>
          <div   className={
            ...
            `${styles.chat_leftbar_option} ${
                activeLeftBarOption === 'home' ? styles.chat_leftbar_option_active : ''
            }`
          }
          ...
          <div
              className={
                `${styles.chat_leftbar_option} ${
                    activeLeftBarOption === 'market' ? styles.chat_leftbar_option_active : ''
                }`
              }
          ...
          <div   className={
            `${styles.chat_leftbar_option} ${
                activeLeftBarOption === 'chat' ? styles.chat_leftbar_option_active : ''
            }`
          }
          ...
          <div   className={
            `${styles.chat_leftbar_option} ${
                activeLeftBarOption === 'bin' ? styles.chat_leftbar_option_active : ''
            }`
          }
